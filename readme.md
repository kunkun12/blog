###  babel && babel plugins与babel macros JavaScript编译技术
...
- 1、 什么是AST？它是源代码语法结构的一种抽象表示(类似浏览器页面用抽象为DOM树来表示)、方便对编程语言进行语法分析、语法检查、代码风格检查、语法转换、代 码优化等，另外像目前的mpvue、taro 也都用到AST转换的思想。可以在[astexplorer](https://astexplorer.net)中查看
...
- https://medium.freecodecamp.org/using-babel-macros-with-react-native-8615aaf5b7df